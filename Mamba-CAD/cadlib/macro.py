...
MAX_N_EXT = 30 # maximum number of extrusion #original 10
MAX_N_LOOPS = 30 # maximum number of loops per sketch #original 6
MAX_N_CURVES = 30 # maximum number of curves per loop $original 15
MAX_TOTAL_LEN = 128 # maximum cad sequence length #original 60
ARGS_DIM = 256
