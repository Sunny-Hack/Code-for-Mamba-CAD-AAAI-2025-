...
class ConfigAE(object):
    ...
    def set_configuration(self):
        ...
        self.n_layers = 4                # Number of Encoder blocks#original 4
        self.n_layers_decode = 4         # Number of Decoder blocks
        self.n_heads = 8                 # Transformer config: number of heads #original 8
        self.dim_feedforward = 512       # Transformer config: FF dimensionality
        self.d_model = 256               # Transformer config: model dimensionality#original 256
        ...
        ##############cfg for mamba settings
        self.m_layers = 4                ## Number of Mamba blocks 
        self.bias = False
        self.expand = 2
        self.vocab_size = 256
    ...
    def parse(self):
        ...
        parser.add_argument('--nr_epochs', type=int, default=4, help="total number of epochs to train")
        ...
        parser.add_argument('--val_frequency', type=int, default=2, help="run validation every x iterations")
