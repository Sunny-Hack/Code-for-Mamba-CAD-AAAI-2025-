...
class ConfigLGAN(object):
    def __init__(self):
        ...
        self.exp_dir = os.path.join(args.proj_dir, args.exp_name, args.exp_path.format(args.ae_ckpt))
    ...
    def set_configuration(self):
        ...
        self.n_dim = 64 #original 64
        self.h_dim = 512 #original 512
        self.z_dim = 256 #original 256 mamba:64*128

        # WGAN-gp configuration
        self.beta1 = 0.5 #original 0.5
        self.critic_iters = 5
        self.gp_lambda = 10
    ...
    def parse(self):
        ...
        parser.add_argument('--exp_path', type=str, required=False, default="lgan_{}", help="path to store lgan model")
        ...
        parser.add_argument('--batch_size', type=int, default=256, help="batch size")#original 256
        parser.add_argument('--num_workers', type=int, default=8, help="number of workers for data loading")

        parser.add_argument('--n_iters', type=int, default=200000, help="total number of iterations to train")#original 200000
        parser.add_argument('--save_frequency', type=int, default=50000, help="save models every x iterations")#original 100000
        parser.add_argument('--lr', type=float, default=2e-4, help="initial learning rate")#original 2e-4
