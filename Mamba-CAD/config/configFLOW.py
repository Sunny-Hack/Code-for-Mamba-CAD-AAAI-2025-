...
class ConfigFLOW(object):
    ...
    def set_configuration(self):
        ...
        self.n_dim = 64 
        self.hidden_dim = 256
        self.num_features = 64*128 #flatten
    ...
    def parse(self):
        ...
        parser.add_argument('--n_iters', type=int, default=100000, help="total number of iterations to train")#original 200000
        parser.add_argument('--save_frequency', type=int, default=20000, help="save models every x iterations")#original 100000
