...
RECORD_FILE = "/home/d3010/lxy/DeepCAD/data/train_val_test_complex.json"
...
def main():
    ...
    parser.add_argument("--n_test", type=int, default=1000)#original 1000
    parser.add_argument("--multi", type=int, default=3)#original 3
