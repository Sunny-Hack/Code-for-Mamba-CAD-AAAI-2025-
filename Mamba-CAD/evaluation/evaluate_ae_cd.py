...
PC_ROOT = "/home/d3010/lxy/DeepCAD/data/pc_cad"
#PC_ROOT = "/home/d3010/lxy/DeepCAD/data/data_fusion/pc_cad"
...
def process_one(path):
    global num, max_len, total_len, n_num
    ...
    try:
        ...
        return None
    num = num + 1
    total_len+=out_vec.shape[0]
    if max_len < out_vec.shape[0]:
        max_len = out_vec.shape[0]
    if out_vec.shape[0] > 59:
        n_num+=1
    ...
    print("valid:", num)
    print("avg_len:", float(total_len/num))
    print("max_len:", max_len)
    print("long_len_num:", n_num)
    return cd
